...
<?php
     include 'db_con.php';
     $SELECT_QUERY="SELECT * FROM product ORDER BY added_date  ";
...
<?php while($row=mysqli_fetch_array($SELECT_QUERY_GET)){?>
  <tr>
      ...
      <td><?php echo $row['file_img_link']; ?></td>
    <td><a class="btn btn-danger" href="delete_prod.php?pid=<?php echo $row['pid']?>;">Remove</a></td>
    </tr>
<?php }?>
